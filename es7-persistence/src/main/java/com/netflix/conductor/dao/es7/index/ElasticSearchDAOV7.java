...
@Trace
@Singleton
public class ElasticSearchDAOV7 extends ElasticSearchBaseDAO implements IndexDAO {

    private static final Logger logger = LoggerFactory.getLogger(ElasticSearchDAOV7.class);
    ...
    private static final String className = ElasticSearchDAOV7.class.getSimpleName();
    ...
    @Inject
    public ElasticSearchDAOV7(Client elasticSearchClient, ElasticSearchConfiguration config, ObjectMapper objectMapper) {
